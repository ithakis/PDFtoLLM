...
\setbeamertemplate{footline}{%
  ...
  \hbox{%
    ...
    \begin{beamercolorbox}[wd=.333333\paperwidth,ht=2.5ex,dp=1ex,right]{footline}%
      \scriptsize\textcolor{MSGrey}{\insertframenumber{}/\insertmainframenumber}\hspace*{2ex}%
    \end{beamercolorbox}%
  }%
  \vskip0pt%
}

% ─── Save main frame count for footer ────────────────────────────────────────
...
\begin{column}{0.55\textwidth}
  \textbf{\textcolor{MSBlue}{Quantitative Background}}
  \begin{itemize}
    \item MSc Computational Finance (UvA, Amsterdam)
    \item \textbf{Two research papers} on option pricing \& hedging with Deep Reinforcement Learning
    \item Experience developing \& deploying ML-based trading strategies (Quant Analyst)
  \end{itemize}
\end{column}
\begin{column}{0.42\textwidth}
  \begin{block}{AI \& Engineering}
    \small
    \begin{itemize}
      \item Built end-to-end OCR tooling for scientific PDF conversion
      \item AI-first development: LLM-assisted research, automated code generation
    \end{itemize}
  \end{block}
\end{column}
\end{columns}
...
% APPENDIX
% =============================================================================
% Save total main frame count before appendix resets it
\renewcommand{\insertmainframenumber}{\inserttotalframenumber}
\appendix

% ─── APPENDIX A: Under the Hood ─────────────────────────────────────────────
\begin{frame}[noframenumbering]{Appendix: Under the Hood}
\vspace{-2pt}
\small
...
\begin{frame}[noframenumbering]{Appendix: Marker Benchmark Performance}
\small
...
\begin{frame}[noframenumbering]{Appendix: Cost \& Productivity Estimation}
\vspace{-8pt}
\scriptsize
...
\begin{column}{0.48\textwidth}
  \begin{block}{\scriptsize Monthly Cost Projection (per analyst)}
    ...
    \vspace{2pt}
    \textbf{Team of 10 (Gemini 3):} \textcolor{AccentGreen!70!black}{\textbf{\$143--286/month}}\\[0pt]
    \textcolor{MSGrey}{\tiny $<$0.2\% of one analyst salary ($\sim$\$15k/mo)}
  \end{block}
\end{column}
\end{columns}
